...
#endif
#if INCLUDE_PROPERTY_HELPPROVIDINGSTATUS
sslog_property_t *PROPERTY_HELPPROVIDINGSTATUS;
#endif
...
#endif
#if INCLUDE_PROPERTY_UID
PROPERTY_UID =  sslog_new_property("http://oss.fruct.org/smartcare#UID", SSLOG_PROPERTY_TYPE_DATA);
#endif
#if INCLUDE_PROPERTY_IMG
...
#endif
#if INCLUDE_PROPERTY_HELPPROVIDINGSTATUS
PROPERTY_HELPPROVIDINGSTATUS =  sslog_new_property("http://oss.fruct.org/smartcare#helpProvidingStatus", SSLOG_PROPERTY_TYPE_DATA);
#endif
#if INCLUDE_PROPERTY_AGE
